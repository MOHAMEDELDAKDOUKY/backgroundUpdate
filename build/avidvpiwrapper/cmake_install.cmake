...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libavidvpiwrapper.so" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/lib/libavidvpiwrapper.so"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
   "/usr/local/lib/libavidvpiwrapper.so")
...
file(INSTALL DESTINATION "/usr/local/lib" TYPE SHARED_LIBRARY FILES "/home/avidbeam/dakdouky_ws/left_object_detection/backgroundUpdate/build/avidvpiwrapper/libavidvpiwrapper.so")
  if(EXISTS "$ENV{DESTDIR}/usr/local/lib/libavidvpiwrapper.so" AND
    ...
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/usr/local/lib/libavidvpiwrapper.so"
         OLD_RPATH "/opt/nvidia/vpi1/lib64:/opt/nvidia/deepstream/deepstream/lib:"
         NEW_RPATH "")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/lib/libavidvpiwrapper.so")
    endif()
  endif()
endif()
